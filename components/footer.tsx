        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/careers" className="text-sm text-background/80 hover:text-primary transition-colors">
                  Careers
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li className="text-sm text-background/80">IT Infrastructure</li>
              <li className="text-sm text-background/80">Cybersecurity</li>
              <li className="text-sm text-background/80">IoT Solutions</li>
              <li className="text-sm text-background/80">Software Development</li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li className="flex items-start gap-2">
                ...
                <span className="text-sm text-background/80">+94 (11) 5 672 666 / +94 (11) 5 752 117</span>
              </li>
              <li className="flex items-start gap-2">
                <MapPin className="h-4 w-4 mt-0.5 text-primary" />
                <span className="text-sm text-background/80">No. 36, Nugegoda Road, Pepiliyana, Sri Lanka</span>
              </li>
            </ul>
          </div>
        </div>
